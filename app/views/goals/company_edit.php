<div class="space-y-6">
    <section>
        <h2 class="text-xl font-semibold">Editar meta da empresa</h2>
    </section>
    <form method="post" action="/goals/company/<?php echo $goal['id']; ?>/update" class="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 space-y-4">
